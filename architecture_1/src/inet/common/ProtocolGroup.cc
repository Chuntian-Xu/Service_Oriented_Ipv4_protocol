...
{
//    EV_INFO<<"!!! --> *ProtocolGroup::findProtocol(int protocolNumber) const"<<endl; // new added
...
{
//    EV_INFO<<"!!! --> *ProtocolGroup::getProtocol(int protocolNumber) const"<<endl; // new added
//    EV_INFO<<"    --> protocolNumber:"<<protocolNumber<<endl; // new added
    auto protocol = findProtocol(protocolNumber);
//    EV_INFO<<"    --> protocol: "<<protocol->getName()<<endl; // new added
    if (protocol != nullptr)
        return protocol;
    else
...
{
//    EV_INFO<<"!!! --> ProtocolGroup::findProtocolNumber(const Protocol *protocol) const"<<endl; // new added
...
{
//    EV_INFO<<"!!! --> ProtocolGroup::getProtocolNumber(const Protocol *protocol) const"<<endl; // new added
//    EV_INFO<<"    --> protocol: "<<protocol->getName()<<endl; // new added
...
ProtocolGroup ProtocolGroup::ethertype("ethertype", {
    { 0x0800, &Protocol::ipv4 },  //2048
//    { 0x0801, &Protocol::ipv4_service },  // new added
    { 0x0806, &Protocol::arp },  //2054
    { 0x2000, &Protocol::cdp },  //8192           // TODO remove it, it's a CISCO code for LLC, ANSAINET project use it currently
    { 0x22EA, &Protocol::srp},   //8938
    { 0x22F0, &Protocol::tsn},   //9844
    { 0x22F3, &Protocol::trill}, //8947
...
//    { 0x0022, &Protocol::ipv4_service },  // new added
...
ProtocolGroup ProtocolGroup::ipprotocol("ipprotocol", {
    ...
    { 2, &Protocol::igmp },
    { 4, &Protocol::ipv4 },
//    { 5, &Protocol::ipv4_service },  // new added
    { 6, &Protocol::tcp },
    { 8, &Protocol::egp },
    { 9, &Protocol::igp },
    { 17, &Protocol::udp },
