...
class INET_API Ipv4NetworkConfigurator : public NetworkConfiguratorBase {
  protected:
    ...
    class Node : public NetworkConfiguratorBase::Node {
      public:
        ...
        std::vector<Ipv4Cidshore *> staticCidshores; //new added
      ...
      public:
        ...
        ~Node() {
            ...
            for (size_t i = 0; i < staticCidshores.size(); i++) delete staticCidshores[i]; //new added
        }
    };
  ...
  public:
    ...
    virtual void configureCidshoreTable(IIpv4CidshoreTable *cidshoreTable);// new added
  ...
  protected:
    ...
    /**
     * Reads sid elements from configuration file and stores the result
     */
    virtual void readManualSidConfiguration(Topology& topology); // new added
    /**
     * Reads cid elements from configuration file and stores the result
     */
    virtual void readManualCidConfiguration(Topology& topology); // new added
    /**
     * Reads cidshore elements from configuration file and stores the result
     */
    virtual void readManualCidshoreConfiguration(Topology& topology); // new added
    ...
    void configureCidshoreTable(Node *node); // new added
    ...
    virtual void dumpConfig(Topology& topology); // new added change

    virtual void dumpSids(Topology& topology);  // new added
    virtual void dumpCids(Topology& topology);  // new added
    virtual void dumpCidshores(Topology& topology);  // new added
    ...
    virtual ICidshoreTable *findCidshoreTable(NetworkConfiguratorBase::Node *node) override; // new added
