...
// layer 3 - Cidshore Table
simsignal_t cidshoreAddedSignal = cComponent::registerSignal("cidshoreAdded");// new added
simsignal_t cidshoreDeletedSignal = cComponent::registerSignal("cidshoreDeleted");// new added
simsignal_t cidshoreChangedSignal = cComponent::registerSignal("cidshoreChanged");// new added
