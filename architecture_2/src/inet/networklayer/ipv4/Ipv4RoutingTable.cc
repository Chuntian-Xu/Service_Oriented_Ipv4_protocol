...
{
    EV_INFO<<"!!! --> *Ipv4RoutingTable::findBestMatchingRoute(const Ipv4Address& dest) const"<<endl;  // new added
...
{
    EV_INFO<<"!!! --> Ipv4RoutingTable::internalAddRoute(Ipv4Route *entry)"<<endl;  // new added
...
//    routes.push_back(entry); // new added
...
{
    EV_INFO<<"!!! --> *Ipv4RoutingTable::internalRemoveRoute(Ipv4Route *entry)"<<endl; // new added
...
{
    EV_INFO<<"!!! --> Ipv4RoutingTable::routeChanged(Ipv4Route *entry, int fieldCode)"<<endl; // new added
