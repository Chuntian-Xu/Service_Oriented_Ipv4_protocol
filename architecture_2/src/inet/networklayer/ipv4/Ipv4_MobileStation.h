...
class IIpv4CidshoreTable;  // new added
...
class INET_API Ipv4_MobileStation : public OperationalBase, public NetfilterBase, public INetworkProtocol, public IProtocolRegistrationListener, public cListener
{
  ...
  protected:
    bool service_flag = false; // ^-^ new added !!!
    Ipv4Address ServiceClient_ipaddr;  // ^-^ new added !!!
    u_short ServiceClient_port = 0; // ^-^ new added !!!

    IIpv4RoutingTable *rt = nullptr;
    IInterfaceTable *ift = nullptr;

    IIpv4SidTable *st = nullptr; // new added
    IIpv4CidshoreTable *ctshore = nullptr; // new added
  ...
  protected:
    ...
    virtual void handleIncomingDatagram_Service(Packet *packet);  // ^-^ new added !!!
    ...
    virtual void sendDatagramToOutput_Service(Packet *packet);  // ^-^ new added !!!
...
#endif // ifndef __INET_IPV4_MOBILESTATION_H
