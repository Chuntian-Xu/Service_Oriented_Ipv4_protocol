...
UdpSocket::UdpSocket()
{
    EV_INFO<< "!!! --> UdpSocket::UdpSocket()" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::bind(int localPort)" <<endl;  // new added
    bind(L3Address(), localPort);
}

void UdpSocket::bind(L3Address localAddr, int localPort)
{
    EV_INFO<< "!!! --> UdpSocket::bind(L3Address localAddr, int localPort)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::connect(L3Address addr, int port)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::sendTo(Packet *pk, L3Address destAddr, int destPort)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::send(Packet *pk)" <<endl;  // new added
    pk->setKind(UDP_C_DATA);
    sendToUDP(pk);
    sockState = CONNECTED;
}
...
{
    EV_INFO<< "!!! --> UdpSocket::close()" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::destroy()" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::setTimeToLive(int ttl)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::setDscp(short dscp)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::setTos(short tos)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::setBroadcast(bool broadcast)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::setMulticastOutputInterface(int interfaceId)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::setMulticastLoop(bool value)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::setReuseAddress(bool value)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::joinMulticastGroup(const L3Address& multicastAddr, int interfaceId)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::leaveMulticastGroup(const L3Address& multicastAddr)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::blockMulticastSources(int interfaceId, const L3Address& multicastAddr, const std::vector<L3Address>& sourceList)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::unblockMulticastSources(int interfaceId, const L3Address& multicastAddr, const std::vector<L3Address>& sourceList)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::leaveMulticastSources(int interfaceId, const L3Address& multicastAddr, const std::vector<L3Address>& sourceList)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::joinMulticastSources(int interfaceId, const L3Address& multicastAddr, const std::vector<L3Address>& sourceList)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> setMulticastSourceFilter(int interfaceId, const L3Address& multicastAddr, UdpSourceFilterMode filterMode, const std::vector<L3Address>& sourceList)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::joinLocalMulticastGroups(MulticastGroupList mgl)" <<endl;  // new added
    if (mgl.size() > 0) {
        UdpJoinMulticastGroupsCommand *ctrl = new UdpJoinMulticastGroupsCommand();
...
{
    EV_INFO<< "!!! --> UdpSocket::leaveLocalMulticastGroups(MulticastGroupList mgl)" <<endl;  // new added
    if (mgl.size() > 0) {
        UdpLeaveMulticastGroupsCommand *ctrl = new UdpLeaveMulticastGroupsCommand();
        ctrl->setMulticastAddrArraySize(mgl.size());
...
{
    EV_INFO<< "!!! --> UdpSocket::sendToUDP(cMessage *msg)" <<endl;  // new added
    if (!gateToUdp)
...
{
    EV_INFO<< "!!! --> UdpSocket::getReceivedPacketInfo(Packet *pk)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::setCallback(ICallback *callback)" <<endl;  // new added
    cb = callback;
}

void UdpSocket::processMessage(cMessage *msg)
{
    EV_INFO<< "!!! --> UdpSocket::processMessage(cMessage *msg)" <<endl;  // new added
...
{
    EV_INFO<< "!!! --> UdpSocket::belongsToSocket(cMessage *msg) const" <<endl;  // new added
    auto& tags = getTags(msg);
