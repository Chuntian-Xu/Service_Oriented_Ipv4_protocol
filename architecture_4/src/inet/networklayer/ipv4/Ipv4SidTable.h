...
class INET_API Ipv4SidTable : public cSimpleModule, public IIpv4SidTable,
  ...
  protected:
    ...
    // helper functions:
    void internalAddSid(Ipv4Sid *ipv4Sid);
    Ipv4Sid *internalRemoveSid(Ipv4Sid *ipv4Sid);
  ...
  public:
     ...
     */
    virtual void addSid(Ipv4Sid *ipv4Sid) override;
    /**
     ...
     * notifications.
     */
    virtual void ipv4SidChanged(Ipv4Sid *ipv4Sid, int fieldCode) override;
    //@}
