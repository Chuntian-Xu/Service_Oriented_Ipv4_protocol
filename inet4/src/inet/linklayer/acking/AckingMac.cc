// src/inet/linklayer/acking/AckingMac.cc
...
void AckingMac::startTransmitting() {
    EV_INFO<<"!!! --> AckingMac::startTransmitting()\n";
...
void AckingMac::handleUpperPacket(Packet *packet) {
    EV << "!!! --> AckingMac::handleUpperPacket(Packet *packet)\n"; // new added
...
void AckingMac::handleLowerPacket(Packet *packet) {
    EV_INFO << "!!! --> AckingMac::handleLowerPacket(Packet *packet)\n"; // new added
...
void AckingMac::encapsulate(Packet *packet) {
    EV_INFO<<"!!! --> AckingMac::encapsulate(Packet *packet)\n"; // new added
...
void AckingMac::decapsulate(Packet *packet) {
    EV_INFO << "!!! --> AckingMac::decapsulate(Packet *packet)\n"; // new added
